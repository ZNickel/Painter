...
public class FilterInversion extends Filter {

    private BooleanProperty active;

    public FilterInversion(FilterSet filterSet, Updatable updatable) {
        super(filterSet, updatable, FilterType.INVERSION);
        active = new BooleanProperty("Active:", updatable, false, true);
    }
    public FilterInversion(FilterSet filterSet, Updatable updatable, Node node) {
        super(filterSet, updatable, FilterType.INVERSION);
